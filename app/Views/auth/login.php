                ...
                <form class="card login-form" method="post" action="/login">
                    <div class="card-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="text" name="username" id="username" value="<?= $credentials['username'] ?? null ?>" required />
                        </div>
                        <div class="form-group input-group">
                            <label for="password">Password</label>
                            <input class="form-control" type="password" name="password" id="password" value="<?= $credentials['password'] ?? null ?>" required />
                        </div>
